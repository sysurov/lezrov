...
void TIM2_IRQHandler(void)
{
	if(TIM_GetITStatus(TIM2,TIM_IT_Update)!=RESET)
	{
		...
		TIM2->CCR1 = 3000 - ((int)(Reg.LServo&0x0F)-7)*200;
		TIM2->CCR2 = 3000 + ((int)(Reg.RServo&0x0F)-7)*200;
		TIM2->CCR3 = abs((int)(Reg.LMotor&0x0F)-7)*5000;
        TIM2->CCR4 = abs((int)(Reg.RMotor&0x0F)-7)*5000;
        if((Reg.LMotor&0x0F)==7){
            GPIO_ResetBits(GPIOB,GPIO_Pin_8|GPIO_Pin_9);
        }else if((Reg.LMotor&0x0F)>7){
        ...
        if((Reg.RMotor&0x0F)==7){
            GPIO_ResetBits(GPIOB,GPIO_Pin_12|GPIO_Pin_13);
        }else if((Reg.RMotor&0x0F)<7){
